            ...
            <div style={{overflowX:"scroll",height:"64vh"}}>
                ...
                <div className='btn-inline report-main'>
                    ...
                    <div className='gray-box' style={{padding:"20px", width:'45%'}}>
                        ...
                        <select className='form-select-purchasing' style={{marginBottom:"60px"}} name='supplier' value={this.state.supplier}  onChange={this.inputHandleChange}>
                            <option >Any</option>
                ...
                <div className='btn-inline report-main'>
                    ...
                    <label>Select Supplier to Generate Report of Stock Orders Categorized by Suppliers</label><br/>
                        <select className='form-select-purchasing' style={{marginBottom:"20px"}} name='purchaseType' value={this.state.purchaseType}  onChange={this.inputHandleChange}>
                        ...
                        <div className='btn-inline' style={{marginTop:"10px"}}>
                            <div style={{width:'48%'}}>
                                ...
                                <input type='date' className='form-input-purchasing' style={{marginBottom:"0px"}} name='from' max={today} value={this.state.from} onChange={this.handleInputFromDateStockChange}/>
                            </div>

                            <div style={{width:'48%'}}>
                                <label style={{fontWeight:"unset"}}>To</label><br/>
                                <input type='date' className='form-input-purchasing' style={{marginBottom:"0px"}} name='to' max={today} min={this.state.from} value={this.state.to} onChange={this.handleInputToDateStockChange}/>
                            </div>
                        </div>
