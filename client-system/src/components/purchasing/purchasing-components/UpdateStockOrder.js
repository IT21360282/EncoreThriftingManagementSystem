...
export default class UpdateStockOrder extends Component {
    ...
    render() {
        return (
        <div>
            <a onClick={this.handlePopUp}><button className="btn btn-warning"  disabled={this.state.isConfirmBtnDisabled}><i class="fa-solid fa-pen-to-square"></i>&nbsp;&nbsp;Update</button></a>
