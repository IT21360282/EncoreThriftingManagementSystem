  ...
  render() {
    return (
        <div>
            ...
            <br/>
            <center>
            <a href='/supplier/BestSupplier'><button type='submit' className='btn btn-warning' style={{ marginTop:"20px"}}>BACK</button></a>
            <a href='/supplier/ContactSupplier'><button type='submit' onClick={this.onSubmit} className='btn btn-success' style={{ marginTop:"20px",marginLeft:'20px'}}>SEND</button></a>
            </center>
            <br/>
            </div>
            <br/>
