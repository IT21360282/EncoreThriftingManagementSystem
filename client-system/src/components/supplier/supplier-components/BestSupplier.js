          ...
          <table className='content-tablesupplier' id='bestsupplierDetailsTable' >
            <thead className='content-table thead tr'>
              <tr className='content-table tbody tr'>
                <th className='content-table th' scope="col"  style={{borderTopLeftRadius:"10px"}}>Supplier ID</th>
                ...
                <th className='content-table th' scope="col" >Delivery Time</th>
                <th className='content-table th' scope="col" style={{border:"none",borderTopRightRadius:"10px"}}>Options</th>
              </tr>
            </thead>
            <tbody scope="raw" >      
            {this.state.supplierDetails.map((results,index)=>(
              <tr className='content-table tbody tr'>
                <td className='content-table td'>{results.supID}</td>
                ...
                <td classname='content-table td' title={results.supTime}>{results.supTime}</td>
