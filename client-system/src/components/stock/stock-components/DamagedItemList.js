...
onSubmit=(e)=>{
  ...
  const{pName,pCategory,pSubCategory,pQuantity,pPrice,pPlacedDate,pImageURL,pReason}=this.state;
        ...
        return (
            ...
            <div className='btn-inline' style={{marginTop:"80px"}} >
              ...
              <div>
                ...
                {/* Add Damaged Item */}
                <Popup  trigger=
                    {<button className='btn btn-warning' style={{marginTop:"15px"}}><i class="fa-solid fa-pen-to-square"></i>Add Damaged Item</button>}
                    modal nested>
                    {
                      close => (
                        <div className='modal' >
                            ...
                            <div className='my-delete'>
                              ...
                              <div className='popUp-form' >
                                ...
                                <div className='label-3'>
                                  ...
                                  <input type='number' className='form-inputg' name='pQuantity' placeholder='0' value={this.state.pQuantity} onChange={this.handleInputChange}/><br/>
                                  </div>

                                  <div className='label-3'>
                                  <label>Unit Price(LKR):</label><br></br>
                                  ...
                                  <textarea className='form-inputg' rows={8} cols={34} type="text" name='pReason' placeholder='Enter Reason' value={this.state.pReason} onChange={this.handleInputChange}></textarea>
                                  </div>
